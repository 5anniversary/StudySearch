...
[Style Share의 swift-style-guide 문서](https://github.com/StyleShare/swift-style-guide/blob/master/README.md)를 참고해 만든 문서입니다.

StudySearch 구성원들이 Swift 코드를 이해하기 쉽고 명확하게 작성하기 위한 스타일 가이드입니다. 구성원들의 의사결정에 따라 수시로 변경될 수 있습니다.
